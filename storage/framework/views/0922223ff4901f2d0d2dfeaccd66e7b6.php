...
<div class="mb-3 pb-1 d-flex align-items-center flex-row">
    <div class="flex-grow-1">
        <h4 class="fs-16 mb-1">Division Details</h4>
        <p class="text-muted mb-0">View division details, including organizations.</p>
    </div>
</div>
                ...
                <div class="mb-2">
                    <table class="table table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                <th>Created At</th>
                                <td><?php echo e(Carbon\Carbon::parse($branch->created_at)->format('d M, Y')); ?></td>
                            </tr>
                        </tbody>
                    </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('typeform.layout.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/prateeklalwani/Desktop/Typeform Main/typeform-dashboard/resources/views/typeform/branch/view.blade.php ENDPATH**/ ?>