        ...
        <div class="card product">
            <div class="card-body">
                <div class="row gy-3">
                    <div class="col-sm-auto">
                        <div class="avatar-lg bg-light rounded p-1">
                            <img src="<?php echo e(URL::asset('build/images/products/img-7.png')); ?>" alt=""
                                class="img-fluid d-block">
                        </div>
                    </div>
                    <div class="col-sm">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\CSB 2025\typeform-dashboard\resources\views/apps-ecommerce-cart.blade.php ENDPATH**/ ?>