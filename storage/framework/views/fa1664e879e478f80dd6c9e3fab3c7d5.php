                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarApexcharts">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-range-area" class="nav-link"><?php echo app('translator')->get('translation.area'); ?></a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-slope"
                                                class="nav-link"><span><?php echo app('translator')->get('translation.slope'); ?></span> <span
                                                    class="badge badge-pill bg-success"><?php echo app('translator')->get('translation.new'); ?></span></a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-feather" class="nav-link"><span><?php echo app('translator')->get('translation.feather'); ?></span> <span
...
<?php /**PATH /Users/prateeklalwani/Desktop/laravel-template-projects/Laravel/default/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>