                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use the <code>border-2 bg-body-secondary</code> class to set an alert with outline.</p>
                                    ...
                                    <div class="live-preview">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <h6>Dark Alert</h6>
                                                <div class="alert alert-dark alert-dismissible border-2 bg-body-secondary fade show mb-0" role="alert">
                                    ...
                                    <div class="live-preview">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <h6>Danger Alert</h6>
                                                <div class="alert alert-danger alert-dismissible bg-danger text-white alert-label-icon fade show mb-xl-0" role="alert">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use the <code>bg-*</code>, <code>border-*</code> & <code>text-white</code> class to set an alert with solid style.</p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/prateeklalwani/Desktop/Typeform Main/typeform-dashboard/resources/views/ui-alerts.blade.php ENDPATH**/ ?>