                            ...
                            <div class="col-xxl-6">
                                ...
                                <div class="toast fade show" role="alert" aria-live="assertive"
                                    ...
                                    <div class="toast-header">
                                        <img src="<?php echo e(URL::asset('build/images/logo-sm.png')); ?>" class="rounded me-2"
                                            alt="..." height="20">
                                    ...
                                    <div>
                                        ...
                                        <div class="bg-light" aria-live="polite" aria-atomic="true"
                                            ...
                                            <div class="toast fade show" role="alert" aria-live="assertive"
                                                ...
                                                <div class="toast-header">
                                                    <img src="<?php echo e(URL::asset('build/images/logo-sm.png')); ?>"
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/notifications.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/prateeklalwani/Desktop/Typeform Main/typeform-dashboard/resources/views/ui-notifications.blade.php ENDPATH**/ ?>