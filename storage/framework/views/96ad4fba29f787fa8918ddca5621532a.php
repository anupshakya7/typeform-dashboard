...
<div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="userProfileCanvasExample">
        ...
        <div class="offcanvas-body profile-offcanvas p-0">
            ...
            <div class="p-3 text-center">
                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto">
                <div class="mt-3">
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="userProfileCanvasExample">
        ...
        <div class="offcanvas-body profile-offcanvas p-0">
            ...
            <div class="p-3 text-center">
                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto profile-img">
                <div class="mt-3">
                    <h5 class="fs-16 mb-1"><a href="javascript:void(0);" class="link-primary username">Lisa Parker</a></h5>
                    <p class="text-muted"><i class="ri-checkbox-blank-circle-fill me-1 align-bottom text-success"></i>Online</p>
                </div>
    ...
    <!-- fgEmojiPicker js -->
    <script src="<?php echo e(URL::asset('build/libs/fg-emoji-picker/fgEmojiPicker.js')); ?>"></script>

    <!-- chat init js -->
    <script src="<?php echo e(URL::asset('build/js/pages/chat.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
    <?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/prateeklalwani/Desktop/laravel-template-projects/Laravel/default/resources/views/apps-chat.blade.php ENDPATH**/ ?>