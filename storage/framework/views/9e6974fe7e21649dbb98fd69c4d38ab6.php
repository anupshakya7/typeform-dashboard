            ...
            <div class="card-body">
                <div class="avatar-lg mx-auto mb-3">
                    <div class="avatar-title bg-light rounded">
                        <img src="<?php echo e(URL::asset('build/images/companies/img-6.png')); ?>" alt="" class="avatar-sm company-logo">
                    </div>
                </div>
...
<script src="<?php echo e(URL::asset('build/js/pages/job-companies-lists.init.js')); ?>"></script>

<!-- App js -->
<script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\CSB 2025\typeform-dashboard\resources\views/apps-job-companies-lists.blade.php ENDPATH**/ ?>