...
<link href="<?php echo e(URL::asset('build/css/custom.min.css')); ?>" id="app-style" rel="stylesheet" type="text/css" />
 <?php echo $__env->yieldContent('css'); ?><?php /**PATH /Users/prateeklalwani/Desktop/Typeform Main/typeform-dashboard-github/resources/views/typeform/partials/head-css.blade.php ENDPATH**/ ?>