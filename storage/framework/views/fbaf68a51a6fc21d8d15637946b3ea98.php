                                ...
                                <div class="col-md-auto">
                                    <div class="avatar-md">
                                        <div class="avatar-title bg-white rounded-circle">
                                            <img src="<?php echo e(URL::asset('build/images/brands/slack.png')); ?>" alt="" class="avatar-xs">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md">
                    ...
                    <div class="card-body">
                        ...
                        <div class="avatar-sm mb-4">
                            <div class="avatar-title bg-secondary-subtle rounded">
                                <img src="<?php echo e(URL::asset('build/images/companies/img-1.png')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <a href="#!">
                            <h5>Web designer</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="avatar-sm mb-4">
                            <div class="avatar-title bg-info-subtle rounded">
                                <img src="<?php echo e(URL::asset('build/images/companies/img-2.png')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <a href="#!">
                    ...
                    <div class="card-body">
                        ...
                        <div class="avatar-sm mb-4">
                            <div class="avatar-title bg-warning-subtle rounded">
                                <img src="<?php echo e(URL::asset('build/images/companies/img-3.png')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <a href="#!">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\CSB 2025\typeform-dashboard\resources\views/apps-job-details.blade.php ENDPATH**/ ?>