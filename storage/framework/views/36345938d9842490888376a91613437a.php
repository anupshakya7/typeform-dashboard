...
<div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="d-flex flex-row gap-2 align-items-center">
                        <!--info here-->
                        <object type="image/svg+xml" data="<?php echo e(URL::asset('build/icons/download.svg')); ?>"></object>
                        <object type="image/svg+xml" data="<?php echo e(URL::asset('build/icons/info.svg')); ?>"></object>
                    </div>
                </div>
                </div><!-- end card header -->
                <div class="card-body pb-0">
                        ...
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>3.8</td>
                                    <td>3.8</td>
                                    <td><span class="trend-blue">3.8%<img class="trend-icon" src="<?php echo e(URL::asset('build/icons/trend-blue.svg')); ?>" alt="ArrowExternalRight"></td>
                                ...
                                <tr>
                                    ...
                                    <td>3.8</td>
                                    <td>3.8</td>
                                    <td><span class="trend-blue">3.8%</span><img class="trend-icon" src="<?php echo e(URL::asset('build/icons/trend-blue.svg')); ?>" alt="ArrowExternalRight"></td>
                                ...
                                <tr>
                                    ...
                                    <td>3.8</td>
                                    <td>3.8</td>
                                    <td><span class="trend-red">3.8%</span><img class="trend-icon" src="<?php echo e(URL::asset('build/icons/trend-red.svg')); ?>" alt="ArrowExternalRight"></td>
