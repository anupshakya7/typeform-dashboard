                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item language-top-button" style="display:none;">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="<?php echo e(url('index/gr')); ?>" class="dropdown-item notify-item language" data-lang="gr" title="German">
                            <img src="<?php echo e(URL::asset('build/images/flags/germany.svg')); ?>" alt="user-image" class="me-2 rounded" height="20"> <span class="align-middle">Deutsche</span>
                        </a>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php if(Auth::user() && Auth::user()->avatar != ''): ?><?php echo e(asset('storage/' . Auth::user()->avatar)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/user-default.png')); ?><?php endif; ?>" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo e(Auth::user()->name); ?></span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?php echo e(Auth::user()->organization ? Auth::user()->organization->name : null); ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
...
<?php /**PATH /Users/prateeklalwani/Desktop/Typeform Main/typeform-dashboard-github/resources/views/typeform/partials/topbar.blade.php ENDPATH**/ ?>