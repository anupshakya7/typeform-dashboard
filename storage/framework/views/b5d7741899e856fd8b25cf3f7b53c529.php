            ...
            <div class="card-header align-items-center d-flex justify-content-between">
                ...
                <div class="flex-shrink-0">
                    <div class="d-flex flex-row gap-2 align-items-center">
                        <!--info here-->
                        <a href="<?php echo e(route('survey.csv',['search_participant'=>request('search_participant'),'country'=>request('country'),'organization'=>request('organization'),'branch'=>request('branch'),'survey_form'=>request('survey_form')])); ?>" type="button" class="btn btn-success"><i
                    ...
                    <table id="scroll-horizontal" class="table nowrap align-middle table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($answer->form): ?>
                                    <a href="<?php echo e(route('survey.qa',$answer)); ?>" class="btn btn-soft-primary btn-sm dropdown"><i
                                        class="ri-eye-fill align-bottom"></i></a>
                                    <a href="<?php echo e(route('survey.single.csv',$answer)); ?>" class="btn btn-soft-primary btn-sm dropdown">
