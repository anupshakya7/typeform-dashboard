                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" id="sync_form" class="btn btn-blue"><i
                                            class="fa-solid fa-arrows-rotate me-2"
                                            id="syncBtnIcon"></i><span>Sync</span></button>
                                </div>
                            ...
                            <div id="form_details">
                                ...
                                <input type="checkbox" name="fields[country]" id="country"> <label
                                    for="country">Country</label> <br>
                                <input type="checkbox" name="fields[state]" id="state" disabled> <label
                                    for="state">State</label> <br>
                                <p
                                    style="display:inline-block;border-radius:5px;color:#fff;padding:4px 10px;font-size:14px;font-weight:500;margin-top:10px;background-color:rgb(142, 15, 15);box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;">
                                    For State you should check country first</p>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="my-3">
                                <div id="addBtnWrapper" style="position: relative;">
                                    <button type="submit" class="btn btn-info float-end mx-1" id="addBtn" disabled>Add
                                        Fields</button>
                                </div>
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            //Success Response 
            function success(response,syncBtnIcon){
...
<?php echo $__env->make('typeform.layout.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/krizmaticcomau/projects.krizmatic.com.au/TypeForm-Version-2.0/resources/views/typeform/form/insertField.blade.php ENDPATH**/ ?>