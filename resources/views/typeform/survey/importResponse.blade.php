    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="live-preview">
                <form action="{{ route('answer.import.csv') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="survey_id" placeholder="Survey Id">
                                </div>
                                <span id="form_message"></span>
                            </div>
                            <div class="mb-3">
                                <label for="form_id" class="form-label">Upload Survey Responses CSV File<span class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="my-3">
                                <div id="addBtnWrapper" style="position: relative;">
                                    <button type="submit" class="btn btn-info float-end mx-1">Import Data</button>
                                </div>
                            </div>
                        </div>
                    </div>
