                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($pillarMeanScore['mean'] as $key => $pillar)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $pillarMeanScore['countryMean'][$key] }}
                                                    </td>
                                                    <td class="text-center">{{ $pillarMeanScore['globalMean'][$key] }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                ...
                                <div class="card-body">
                                    <div class="live-preview">
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap mt-3" id="survey-table" style="display: none;">
                                                <thead class="table-light">
                                                    <tr>
