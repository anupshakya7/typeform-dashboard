        ...
        <div class="d-flex align-items-center justify-content-between">
            <div class="flex-shrink-0">
                <div class="d-flex gap-1 flex-wrap">
                    ...
                    <a href="{{ route('organization.create') }}" class="btn btn-info add-btn"><i
            ...
            <div class="flex-shrink-0">
                <div class="d-flex flex-row gap-2 align-items-center">
                    <!--info here-->
                    <a href="{{ route('organization.csv') }}" class="btn btn-success"><i
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a href="{{ route('organization.show', $organization) }}"
                                                            class="dropdown-item"><i
                                                                class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                            View</a>
                                                    </li>
                                                    <li><a href="{{ route('organization.edit', $organization) }}"
                                                    ...
                                                    @if (Auth::user()->organization_id !== $organization->id)
                                                        <li>
                                                            <button class="dropdown-item remove-item-btn"
                                                                ...
                                                                data-item-name="{{ $organization->name }}"
                    ...
                    <!--Pagination Section -->
                    @include('typeform.partials.pagination', ['paginator' => $organizations])
                    <!--Pagination Section -->
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <form id="deleteForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-muted">Deleting this item will permanently remove it from the system, <span
                                class="text-danger"> along with all associated user details who are part of this
                                company</span></p>
