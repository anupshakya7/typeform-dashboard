        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="flex-shrink-0">
                <div class="d-flex flex-row gap-2 align-items-center">
                    <!--info here-->
                    <a href="{{ route('branch.csv') }}" class="btn btn-success"><i
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a href="{{ route('branch.show', $branch) }}"
                                                            class="dropdown-item"><i
                                                                class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                            View</a>
                                                    </li>
                                                    <li><a href="{{route('branch.edit',$branch)}}" class="dropdown-item edit-item-btn"><i
                                                                class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                            Edit</a>
                                                    </li>
                                                    <li>
                                                        <button class="dropdown-item remove-item-btn"
                                                            data-item-id="{{ $branch->id }}"
                                                            data-item-name="{{ $branch->name }}" data-bs-toggle="modal"
                    ...
                    <!--tfooter section-->
                    @include('typeform.partials.pagination', ['paginator' => $branches])
                </div>
            </div>
        </div>
        <!--end col-->
