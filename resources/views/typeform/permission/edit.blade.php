...
<div class="card" id="formForm">
    ...
    <div class="card-body">
        <div class="live-preview">
            <form id="mainForm" action="{{route('permission.update',$permission)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{old('name',$permission->name)}}" name="name" class="form-control" placeholder="Name" id="name">
                            @error('name')
